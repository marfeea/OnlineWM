...
from .onlinewm_marl_env_cfg import OnlinewmMarlEnvCfg


class OnlinewmMarlEnv(DirectMARLEnv):
    cfg: OnlinewmMarlEnvCfg

    def __init__(self, cfg: OnlinewmMarlEnvCfg, render_mode: str | None = None, **kwargs):
